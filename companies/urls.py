...
urlpatterns = [    
    ...
    path('companies_list/company_detail/<int:pk>', views.CompanyDetail.as_view(), name='company-detail'),
    ...
    path('stafflist_detail/summaries_list/summary_detail/<int:pk>', views.summary_detail, name='summary_detail'),
    path('stafflist_detail/summaries_list/summary_delete/<int:pk>', views.summary_delete, name='summary_delete'),
