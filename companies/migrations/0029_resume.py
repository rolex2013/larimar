    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidatenamemiddlename', models.CharField(max_length=64, verbose_name='Отчество')),
                ('candidatenamelastname', models.CharField(max_length=64, verbose_name='Фамилия')),
                ...
                ('stafflist', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.CASCADE, related_name='resume_stafflist', to='companies.StaffList', verbose_name='Должность')),
            ],
            options={
                'verbose_name': 'Резюме',
