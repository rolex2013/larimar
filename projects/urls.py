...
urlpatterns = [
    ...
    path('companies_list/company_create/<int:companyid>', views.CompanyCreate.as_view(), name = 'company_create'),
    ...
    path('projects_list/project_create/<int:companyid>', views.ProjectCreate.as_view(), name='project_create'),
    ...
    path('tasks_list/task_create/<int:projectid>', views.TaskCreate.as_view(), name='task_create'),
