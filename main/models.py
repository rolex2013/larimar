...
class Meta_Param(TranslateFieldMixin, models.Model):
    ...
    name_en = models.CharField(_("Наименование_en"), max_length=64, blank=True, null=True)
...
class Dict_ProtocolType(TranslateFieldMixin, models.Model):
    name_ru = models.CharField(_("Наименование_ru"), max_length=64)
    name_en = models.CharField(_("Наименование_en"), max_length=64, blank=True, null=True)
    sort = models.PositiveSmallIntegerField(_("Сортировка"), default=1, blank=True, null=True)
    is_active = models.BooleanField(_("Активность"), default=True)
...
class Component(TranslateFieldMixin, MPTTModel):
    parent = TreeForeignKey('self', null=True, blank=True, limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='component_children', verbose_name=_("Головной компонент"))
    name_ru = models.CharField(_("Наименование_ru"), max_length=64, blank=True, null=True)
    name_en = models.CharField(_("Наименование_en"), max_length=64, blank=True, null=True)
    code = models.CharField(_("Код"), max_length=64)
    description_ru = models.CharField(_("Описание_ru"), max_length=256, blank=True, null=True)
    description_en = models.CharField(_("Описание_en"), max_length=256, blank=True, null=True)
    menu_ru = models.CharField(_("Пункт меню_ru"), max_length=256, blank=True, null=True)
    menu_en = models.CharField(_("Пункт меню_en"), max_length=256, blank=True, null=True)
...
class Notification(TranslateFieldMixin, models.Model):
    objecttype = models.ForeignKey('Meta_ObjectType', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='meta_objecttype', verbose_name=_("Тип Объекта"))
    ...
    type = models.ForeignKey('Dict_ProtocolType', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='protocol_type', verbose_name=_("Тип"))
