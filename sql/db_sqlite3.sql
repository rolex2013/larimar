...
*/
insert into main.main_dict_theme (`id`, `name`, `description`, `is_active`, `lft`, `rght`, `tree_id`, `level`, `parent_id`) values (1, 'Архитектура', null, 1, 1, 4, 1, 0, null);
insert into main.main_dict_theme (`id`, `name`, `description`, `is_active`, `lft`, `rght`, `tree_id`, `level`, `parent_id`) values (2, 'Античная архитектура', null, 1, 2, 3, 1, 1, 1);
/*
