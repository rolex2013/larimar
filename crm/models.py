...
class Client(models.Model):
    ...
    company = models.ForeignKey('companies.Company', on_delete=models.CASCADE, related_name='result_company_client', verbose_name=_("Организация"))
    manager = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='result_manager_client', verbose_name=_("Менеджер"))
    user = models.OneToOneField('auth.User', blank=True, null=True, on_delete=models.CASCADE, related_name='result_user_client', verbose_name=_("Пользователь"))
    is_notify = models.BooleanField(_("Оповещать"), default=False)
    protocoltype = models.ForeignKey('main.Dict_ProtocolType', blank=True, null=True, on_delete=models.CASCADE, related_name='result_protocoltype_client', verbose_name=_("Протокол оповещения"))
    type = models.ForeignKey('Dict_ClientType', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='client_type_client', verbose_name=_("Тип клиента"))
    status = models.ForeignKey('Dict_ClientStatus', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='client_status_client', verbose_name=_("Статус клиента"))
    ...
    currency = models.ForeignKey('finance.Dict_Currency', on_delete=models.CASCADE, related_name='result_currency_client', verbose_name=_("Валюта"))
    cost = models.DecimalField(_("Стоимость"), max_digits=12, decimal_places=2, default=0)
    percentage = models.DecimalField(_("Процент выполнения"), max_digits=5, decimal_places=2, default=0)
    datecreate = models.DateTimeField(_("Создан"), auto_now_add=True)
    dateclose = models.DateTimeField(_("Дата закрытия"), auto_now_add=False, blank=True, null=True)
    # initiator = models.CharField(_("Инициатор"), max_length = 5, choices=WHO_INIT)
    initiator = models.ForeignKey('Dict_ClientInitiator', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='client_initiator_client', verbose_name=_("Инициатор клиента"))
    author = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='client_author', verbose_name=_("Автор"))
    members = models.ManyToManyField('auth.User', related_name='client_members', verbose_name=_("Участники"))
    is_active = models.BooleanField(_("Активность"), default=True)
...
class ClientTask(SetPropertiesDashboardMixin, MPTTModel):
    ...
    client = models.ForeignKey('Client', on_delete=models.CASCADE, related_name='resultclient', verbose_name=_("Клиент"))
    parent = TreeForeignKey('self', null=True, blank=True, limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='task_children', verbose_name=_("Задача верхнего уровня"))
    assigner = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='clienttask_assigner', verbose_name=_("Исполнитель"))
    cost = models.DecimalField(_("Стоимость"), max_digits=12, decimal_places=2)
    percentage = models.DecimalField(_("Процент выполнения"), max_digits=5, decimal_places=2, default=0)
    structure_type = models.ForeignKey('Dict_ClientTaskStructureType', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='clienttask_structure_type', verbose_name=_("Тип в иерархии"))
    type = models.ForeignKey('Dict_ClientTaskType', null=True, blank=True, limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='clienttask_type', verbose_name=_("Тип"))
    ...
    status = models.ForeignKey('Dict_ClientTaskStatus', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='clienttask_status', verbose_name=_("Статус"))
    ...
    initiator = models.ForeignKey('Dict_ClientInitiator', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='clienttask_initiator', verbose_name=_("Инициатор"))
    is_active = models.BooleanField(_("Активность"), default=True)
...
class ClientTaskComment(models.Model):
    ...
    time = models.DecimalField(_("Время работы, час."), max_digits=6, decimal_places=2, blank=False, null=False, default=0)
    cost = models.DecimalField(_("Стоимость"), max_digits=9, decimal_places=2, default=0)
    task = models.ForeignKey('ClientTask', on_delete=models.CASCADE, related_name='resultclienttask', verbose_name=_("Задача"))
    datecreate = models.DateTimeField(_("Создан"), auto_now_add=True)
...
class ClientEvent(SetPropertiesDashboardMixin, models.Model):
    ...
    client = models.ForeignKey('Client', on_delete=models.CASCADE, related_name='event_client', verbose_name=_("Клиент"))
    task = models.ForeignKey('ClientTask', null=True, blank=True, limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='eventtask', verbose_name=_("Связанная задача"))
    assigner = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='event_assigner', verbose_name=_("Исполнитель"))
    type = models.ForeignKey('Dict_ClientEventType',
                             limit_choices_to={'is_active': True},
                             on_delete=models.CASCADE,
                             related_name='event_type',
                             verbose_name=_("Тип события"))
    status = models.ForeignKey('Dict_ClientEventStatus', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='event_status', verbose_name=_("Статус события"))
    datecreate = models.DateTimeField(_("Дата создания"), auto_now_add=True)
    dateclose = models.DateTimeField(_("Дата закрытия"), auto_now_add=False, blank=True, null=True)
    author = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='event_user', verbose_name=_("Автор"))
    initiator = models.ForeignKey('Dict_ClientInitiator', limit_choices_to={'is_active':True}, on_delete=models.CASCADE, related_name='event_initiator', verbose_name=_("Инициатор"))
    is_active = models.BooleanField(_("Активность"), default=True)
...
class ClientEventComment(models.Model):
    name = models.CharField(_("Наименование"), max_length=128)
    description = RichTextUploadingField(_("Описание"))
    event = models.ForeignKey('ClientEvent', on_delete=models.CASCADE, related_name='resultclientevent', verbose_name=_("Событие"))
    datecreate = models.DateTimeField(_("Создан"), auto_now_add=True)
...
class ClientFile(models.Model):
    ...
    uname = models.CharField(_("Уникальное наименование"), null=True, blank=True, max_length=255)
    client = models.ForeignKey('Client', null=True, blank=True, on_delete=models.CASCADE, related_name='client_file', verbose_name=_("Клиент"))
    task = models.ForeignKey('ClientTask', null=True, blank=True, on_delete=models.CASCADE, related_name='clienttask_file', verbose_name=_("Задача"))
    taskcomment = models.ForeignKey('ClientTaskComment', null=True, blank=True, on_delete=models.CASCADE, related_name='clienttaskcomment_file', verbose_name=_("Комментарий"))
    ...
    eventcomment = models.ForeignKey('ClientEventComment', null=True, blank=True, on_delete=models.CASCADE, related_name='clienteventcomment_file', verbose_name=_("Комментарий события"))
    ...
    datecreate = models.DateTimeField(_("Создан"), auto_now_add=True)
    author = models.ForeignKey('auth.User', null=True, blank=True, on_delete=models.CASCADE, verbose_name=_("Автор"))
    is_active = models.BooleanField(_("Активность"), default=True)
