        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_close",
                    models.BooleanField(
                        default=False, verbose_name="Закрывает событие"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="resultclienteventlog",
                        to="crm.clientevent",
                        verbose_name="Событие",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        limit_choices_to={"is_active": True},
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="clientevent_status_log",
                        to="crm.dict_clienteventstatus",
                        verbose_name="Статус События",
                    ),
                ),
